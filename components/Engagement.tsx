...
export default function LikesReplies(params: { tweetId: number }) {
    ...
    return (
        <div className="flex flex-row my-1">
            <svg className="my-1 cursor-pointer group" width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
